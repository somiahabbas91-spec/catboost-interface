...
L(mm)= st.number_input("L (mm)", value=400.0)
H1(mm) = st.number_input("H1(mm) ", value=50.0)
Bf1 (mm)= st.number_input("Bf1 (mm)", value=20.0)
Bl1 (mm)= st.number_input("Bl1 (mm)", value=10.0)
t1 (mm)= st.number_input("t1 (mm)", value=1.2)
R1   = st.number_input("R1   ", value=2.3)
e (mm)= st.number_input("e (mm)", value=25.0)
a (mm)= st.number_input("a (mm)", value=13.0)
